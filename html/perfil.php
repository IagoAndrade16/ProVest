        ...
        <div class="col-md-4">
          <div class="p-3">
            ...
            <a href="#" id="foto-perfil" title="Trocar foto">
              <img src="../img/fotoPessoa.jpg" alt="Foto-perfil" width="150px" height="150px"
            ...
            <div class="card-body">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-book"
                    viewBox="0 0 16 16">
                    <path
                ...
                <li class="list-group-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-map"
                    viewBox="0 0 16 16">
                ...
                <li class="list-group-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-laptop"
                    viewBox="0 0 16 16">
                    <path
