...
<body>
    ...
    $estados = array("Estados", "Acre", "Alagoas", "Amapá", "Amazonas", "Bahia", "Ceará", "Espírito Santo", "Goiás", "Maranhão", "Mato Grosso", "Mato Grosso do Sul", "Minas Gerais", "Pará", "Paraíba", "Paraná", "Pernambuco", "Piauí", "Rio de Janeiro", "Rio Grande do Norte", "Rio Grande do Sul", "Rondônia", "Roraima", "Santa Catarina", "São Paulo", "Sergipe", "Tocantins", "Distrito Federal");
    $acre = array("Cidade", "Acrelândia", "Assis Brasil", "Brasiléia", "Bujari", "Capixaba", "Cruzeiro do Sul", "Epitaciolândia", "Feijó", "Jordão", "Manoel Urbano", "Marechal Thaumaturgo", "Mâncio Lima", "Plácido de Castro", "Porto Acre", "Porto Walter", "Rio Branco", "Rodrigues Alves", "Santa Rosa do Purus", "Sena Madureira", "Senador Guiomard", "Tarauacá", "Xapuri");
    $alagoas = array("Cidade", "Maceió", "Arapiraca", "Rio Largo");
    ?>
    <!--------------------------------------------------------CODIGO PHP-------------------------------------------------------->
    <div>
            ...
            <center>
                ...
                <div class="estado">
                    ...
                    <select name="cidade_usuario">
                        ...
                        <?php if ("Acre" == $estados[1]) { ?>
                            <?php foreach ($acre as $AC) { ?>
                                <option value=" <?php echo $AC; ?> ">
                                    <?php echo $AC; ?>
                                    </opiton>
                                <?php } ?>

                            <?php } elseif ("Alagoas" == $estados[2]) { ?>
                                <?php foreach ($alagoas as $AL) { ?>
                                    <opition value=" <?php echo $AL; ?> ">
                                        <?php echo $AL; ?>
                                    </opition>
                                <?php } ?>
                            <?php } ?>
