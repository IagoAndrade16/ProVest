...
$pesquisa = htmlspecialchars(addslashes($_GET['pesquisa']));
                    ...
                    <div class="col-md-4">
                        <div class="p-3">
                            <div class="card" style="width: 18rem;">
                                <img style="object-fit: cover" width="286px" height="220px" src="<?php echo ("../php/upload/" . $linha[9]); ?>" alt="foto curso">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $linha[3]; ?></h5>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item" style="white-space: nowrap; width: 100%; overflow: hidden; text-overflow: ellipsis;">
                                    ...
                                    <a href="../html/ver-curso.php?nomeC=<?php echo $linha[3]; ?>&enderecoC=<?php echo $linha[6]; ?>&telefoneC=<?php echo $linha[7]; ?>&celular=<?php echo  $linha[8]; ?>&tipo=<?php echo $linha[10]; ?>&categoria=<?php echo $linha[2]; ?>&descricao=<?php echo $linha[11]; ?>&fotoC=<?php echo ("../php/upload/" . $linha[9]); ?>&linkC=<?php echo $linha[14]; ?>&emailC=<?php echo $linha[15]; ?>" class="btn btn-dark">Ver curso</a>
                                </div>
                            </div>
                        </div>
                    </div>
