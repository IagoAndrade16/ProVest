...
if (isset($_POST['btn-salvar'])) {
    ...
    if (!empty($categoria)) {
        $edit1 = "UPDATE cursos SET categoria = '$cat' WHERE codC = $sessionedi";
    ...
    if (!empty($celularC)) {
        $edit2 = "UPDATE cursos SET celularC = '$celularC' WHERE codC = $sessionedi";
    ...
    if (!empty($descricao)) {
        $edit3 = "UPDATE cursos SET descricao = '$descricao' WHERE codC = $sessionedi";
    ...
    if (!empty($cidadeC) && $cidadeC !== "Cidade" ) {
        $edit4 = "UPDATE cursos SET cidadeC = '$cidadeC' WHERE codC = $sessionedi";
    ...
    if (!empty($endereçoC)) {
        $edit5 = "UPDATE cursos SET endereçoC = '$endereçoC' WHERE codC = $sessionedi";
    ...
    if (!empty($estados) && $estados !== "Estado") {
        $edit6 = "UPDATE cursos SET estados = '$estados' WHERE codC = $sessionedi";
    ...
    if (!empty($nome)) {
        $edit7 = "UPDATE cursos SET nome = '$nome' WHERE codC = $sessionedi";
    ...
    if (!empty($tipoEnsino)) {
        $edit8 = "UPDATE cursos SET tipoEnsino = '$tipE' WHERE codC = $sessionedi";
    ...
    if (!empty($telefC)) {
        $edit9 = "UPDATE cursos SET telefC = '$telefC' WHERE codC = $sessionedi";
